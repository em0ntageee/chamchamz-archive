    ...
    <section id="hero-section" className="relative overflow-hidden pt-12 pb-16 md:pt-20 md:pb-24 px-4">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10 flex flex-col items-center">
        ...
        >
          ...
          <div className="w-28 h-28 md:w-36 md:h-36 rounded-full bg-gradient-to-tr from-brand-cyan-200 via-white to-brand-blue-200 border-4 border-slate-800 flex items-center justify-center shadow-md relative group hover:rotate-3 transition-transform">
            {/* Custom SVG Cute Hamster Mascot Face */}
            ...
            <span className="absolute -top-1 -right-3 bg-rose-400 text-white text-[10px] font-bold px-2 py-0.5 rounded-full border-2 border-slate-800 rotate-12 shadow-sm font-sans">
              CHAMCHAM 🐹
            </span>
          </div>
